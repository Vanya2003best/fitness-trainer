...
export const translations = {
  ...
  generator: {
    ...
    location: { ru: 'Где тренируетесь', pl: 'Gdzie trenujesz' },
    locationPlaceholder: { ru: 'Выбери место', pl: 'Wybierz miejsce' },
    locations: {
      gym: { ru: 'В тренажёрном зале', pl: 'Na siłowni' },
      home: { ru: 'Дома', pl: 'W domu' },
      outdoor: { ru: 'На улице', pl: 'Na zewnątrz' },
    },
    equipment: { ru: 'Доступное оборудование', pl: 'Dostępny sprzęt' },
    equipmentPlaceholder: { ru: 'Выбери оборудование', pl: 'Wybierz sprzęt' },
    equipmentOptions: {
      full_gym: { ru: 'Полный зал (все тренажёры)', pl: 'Pełna siłownia (wszystkie maszyny)' },
      basic_gym: { ru: 'Базовый зал (штанга, гантели, турник)', pl: 'Podstawowa siłownia (sztanga, hantle, drążek)' },
      dumbbells: { ru: 'Только гантели', pl: 'Tylko hantle' },
      minimal: { ru: 'Минимум (резинки, коврик)', pl: 'Minimum (gumy, mata)' },
      none: { ru: 'Без оборудования', pl: 'Bez sprzętu' },
    },
    limitations: { ru: 'Ограничения или пожелания', pl: 'Ograniczenia lub preferencje' },
    limitationsPlaceholder: { ru: 'Больная спина, без прыжков...', pl: 'Problemy z kręgosłupem, bez skoków...' },
